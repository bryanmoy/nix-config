...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "Bryan Moy"
    user-mail-address "dev@bryanmoy.com")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/bryanmoy/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/bryanmoy/bin" "/profile/bin" "/Users/bryanmoy/.npm-packages/bin" "/Users/bryanmoy/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
